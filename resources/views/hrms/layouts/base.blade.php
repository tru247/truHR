...
<div id="main">
    ...
    <section id="content_wrapper">
        ...
        <footer id="content-footer" class="affix">
            <div class="row">
                <div class="col-md-6">
                    <span class="footer-legal">C.E.O. Ogego © 2018 All rights reserved. By <a
                                href="http://www.trulancetechnologies.com/" target="_blank">Charles Evans Ogego Otieno</a></span>
                </div>
